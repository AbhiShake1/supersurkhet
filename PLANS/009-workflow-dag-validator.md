# 009 - Workflow DAG Validator

## Task
Create validator enforcing DAG acyclicity, reachable terminals, and required node properties for workflow definitions.
...
- `apps/site/src/features/plugin-builder/domain/validation/workflow-dag-validator.test.ts`
...
## Definition Of Done
- Validator reports precise diagnostics with path annotations.
- Cycle and orphan detection is deterministic.
- Tests include valid DAGs, cycles, disconnected nodes, and malformed edges.

## Verification
- `pnpm --filter supersurkhet test -- workflow-dag-validator.test.ts`
