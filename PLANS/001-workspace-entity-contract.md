# 001 - Workspace Entity Contract

## Task
Define normalized draft workspace entities with stable IDs and strict validators for schemas, fields, derivations, refinements, workflows, nodes, edges, actions, and tabs.
...
- `apps/site/src/features/plugin-builder/domain/workspace/workspace-entities.test.ts`
...
## Definition Of Done
- Exports a single canonical entity map and ID types.
- Validation rejects malformed entities and duplicate IDs.
- Tests cover happy path plus all entity-level validation failures.

## Verification
- `pnpm --filter supersurkhet test -- workspace-entities.test.ts`
