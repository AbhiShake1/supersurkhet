 ...
 */
export type VarFrom<T> = Path<T> | "current" | "accumulator" | [[1 | 2 | 3 | number], ...(string | number)[]] | ArrayPath<T>;
...
export type LogicExpr<TVars = any> =
  ...
  | {
     ...
     * ```
     */
    var: VarFrom<TVars> | "current" | "accumulator" | [[1 | 2 | 3 | number], ...(string | number)[]] | ArrayPath<TVars>
  }
  | {
    /**
  ...
  | {
     ...
     * ```
     */
    "-": number | [number, number?] | (number | { var: VarFrom<TVars> & {} })[]
  }
  | {
    /**
  ...
  | {
     ...
     * ```
     */
    ">": [number | string | { var: VarFrom<TVars> & {} }, number | string | { var: VarFrom<TVars> & {} }]
  }
  | {
    /**
  ...
  | {
     ...
     * ```
     */
    get: [object | { var: VarFrom<TVars> & {} }, string | number | { var: VarFrom<TVars> & {} }]
  }
  | {
    /**
 ...
 */
export interface MethodDefinition<TArgs = any, TContext = any, TAbove = any, TEngine = any> {
  /**
   ...
   */
  method: (args: TArgs, context: TContext, above: TAbove[], engine: TEngine) => any;
   ...
   */
  asyncMethod?: (args: TArgs, context: TContext, above: TAbove[], engine: TEngine) => Promise<any>;
}
