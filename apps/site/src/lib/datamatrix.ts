...
export const dataMatrixActionSchema = z.object({
	...
	navigation: z.object({
		url: z.string().url(),
		params: z.record(z.string(), z.union([z.string(), z.boolean(), z.number()])).optional()
	}).optional(),
	post_connect: z.object({
	...
	flow: z.object({
		steps: z.array(z.object({
			step: z.number(),
			type: z.enum(["menu_display", "order_building", "order_confirmation", "payment_selection"]),
			...
			options: z.array(z.enum(["card", "mobile_payment", "cash"])).optional(),
