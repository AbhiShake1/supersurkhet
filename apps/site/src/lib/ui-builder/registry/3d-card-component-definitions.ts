    ...
    defaultChildren: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            children:
              'This is a standalone 3D card body with interactive effects',
          },
          {
          ...
          },
          {
            ...
            props: {
              ...
              as: 'button',
              className:
                'px-4 py-2 rounded-xl bg-black dark:bg-white dark:text-black text-white text-xs font-bold mt-4',
            },
