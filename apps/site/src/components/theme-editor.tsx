          ...
          <Tabs defaultValue="light" className="w-full">
            ...
            <TabsContent value="light" className="space-y-4">
              {themeProperties.slice(0, 5).map((prop) => (
                <div key={`light-${prop}`} className="flex items-center space-x-2">
                  <Label className="w-32 capitalize">{prop.replace(/-/g, ' ')}</Label>
                  <div className="flex items-center space-x-2">
                    <Input
                      type="color"
                      value={lightTheme[prop] || "#000000"}
                      onChange={(e) => handleThemeChange("light", prop, e.target.value)}
                ...
                <div key={`dark-${prop}`} className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Input
                      ...
                      onChange={(e) => handleThemeChange("dark", prop, e.target.value)}
                      className="w-16 h-8 p-0 border"
                    />
                    <Input
