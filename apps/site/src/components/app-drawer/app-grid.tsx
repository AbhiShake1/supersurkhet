...
function findItem(id: UniqueIdentifier, businesses: Business[], folders: Folder[]) {
		...
		>
			...
			>
				{isDragTarget ? (
					...
					<div className={`${iconSizeClasses[iconSize]} rounded-full bg-primary/30 border-2 border-dashed border-primary/70 flex items-center justify-center flex-shrink-0 relative overflow-hidden`}>
...
function FolderIconComponent(props: FolderIconComponentProps) {
	return (
		<SortableFolderIconComponent {...props} />
	);
}
