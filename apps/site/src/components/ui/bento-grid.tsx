...
export type BentoCardProps = z.infer<typeof BentoCardSchema> & ComponentPropsWithoutRef<"div">;
...
const iconMap: Record<string, React.ElementType> = {
  // To be populated with actual icon components when you import them
  // For example: "RocketIcon": RocketIcon, "GearIcon": GearIcon, etc.
};
