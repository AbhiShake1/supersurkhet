...
function _PartyManagement({ slug }: PartyManagementProps) {
	...
	const { data: parties = [], isLoading, error } = api.party.useGet({
		keys: [slug],
	});
	...
	if (error) {
		return (
			<div className="flex flex-col items-center justify-center p-8 text-center">
				...
				<h3 className="text-lg font-medium text-gray-900 mb-1">Error loading parties</h3>
	...
	const PartyCard = ({ party }: { party: Party & { _?: { soul: string } } }) => {
		return (
