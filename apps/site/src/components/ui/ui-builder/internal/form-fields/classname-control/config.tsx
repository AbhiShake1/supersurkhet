...
import { filterClassnameArray } from './utils';
...
export const CONFIG: ConfigType = {
  width: {
    ...
    possibleTypes: [
      null,
      ...filterClassnameArray(TAILWIND_AUTO_WIDTH_CLASSES, [
        'w-full',
        'w-max',
      ] as const),
      ...TAILWIND_FIXED_WIDTH_CLASSES,
  ...
  height: {
    ...
    possibleTypes: [
      null,
      ...filterClassnameArray(TAILWIND_AUTO_HEIGHT_CLASSES, [
        'h-full',
        'h-auto',
      ] as const),
      ...TAILWIND_FIXED_HEIGHT_CLASSES,
    ...
    options: [
      {
        value: 'h-full',
        tooltip: 'Fill (h-full)',
        icon: <FillIcon className="rotate-90" />,
      },
      {
        value: 'h-auto',
        tooltip: 'Hug (h-auto)',
        icon: <HugIcon className="rotate-90" />,
      },
      {
        value: '_h-fixed',
        label: 'Fixed',
  ...
  display: {
    ...
    possibleTypes: [
      null,
      ...filterClassnameArray(TAILWIND_DISPLAY_CLASSES, [
        'block',
        'inline',
        'flex',
      ] as const),
  ...
  flexSettings: {
    ...
    possibleTypes: [
      ...
      ...TAILWIND_JUSTIFY_CONTENT_CLASSES,
      ...TAILWIND_GAP_CLASSES,
      ...filterClassnameArray(TAILWIND_FLEX_WRAP_CLASSES, [
        'flex-wrap',
        'flex-nowrap',
        'flex-wrap-reverse',
      ] as const),
