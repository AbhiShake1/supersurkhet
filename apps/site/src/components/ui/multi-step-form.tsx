            ...
            >
              ...
              >
                {currentField.map((field) => (
                  <div key={field.fieldConfig?.label?.toString() ?? ""} className="space-y-2">
                    <Label htmlFor={field.fieldConfig?.label?.toString() ?? ""}>{field.fieldConfig?.label}</Label>
                    <Input
                      ...
                      className={cn(
                        errors[field.fieldConfig?.label?.toString() as string] && 'border-destructive',
                      )}
                    />
                    {errors[field.fieldConfig?.label?.toString() as string] && (
                      <p className="text-destructive text-sm">
                        {errors[field.fieldConfig?.label?.toString() as string]?.message as string}
                      </p>
                    )}
                  </div>
                ))}
