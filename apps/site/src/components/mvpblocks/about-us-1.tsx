...
const defaultValues: AboutUsProps['values'] = [
  {
    title: 'Innovation',
    description:
      'We constantly push boundaries and explore new possibilities to create cutting-edge solutions. We believe HTTP is so 2020.',
    icon: 'Lightbulb',
  },
  {
    title: 'Collaboration',
...
export default function AboutUs1() {
  const aboutData = {
    title: 'About Us',
    subtitle:
      'A decentralized superapp.',
    mission:
      'Our mission is to help every business go online in seconds and multiply its revenue.',
    vision:
      'We envision a world where every business, regardless of size or technical expertise, can effortlessly establish a powerful online presence and thrive in the digital economy.',
        ...
        <div ref={valuesRef} className="mb-24">
          ...
          >
            ...
            <p className="text-muted-foreground mx-auto mt-4 max-w-2xl text-lg">
              The principles that guide our commitment to empowering businesses and fostering digital growth.
            </p>
          </motion.div>
