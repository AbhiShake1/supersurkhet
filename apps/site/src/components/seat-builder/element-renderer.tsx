    ...
    switch (element.type) {
      ...
      case 'table':
        return (
          <Square
            {...iconProps}
            className={cn(iconProps.className, 'text-cyan-600')}
          />
        );
      case 'stairs':
        return (
          <Stairs
            {...iconProps}
            className={cn(iconProps.className, 'text-amber-700')}
          />
        );
      case 'garden':
        return (
      ...
      case 'door':
        return (
          <Door
            {...iconProps}
            className={cn(iconProps.className, 'text-gray-700')}
          />
        );
      case 'wall':
        return (
          <Columns
            {...iconProps}
            className={cn(iconProps.className, 'text-gray-800')}
          />
        );
      case 'window':
        return (
          <Window
            {...iconProps}
            className={cn(iconProps.className, 'text-sky-400')}
          />
        );
      case 'bar':
        return (
      ...
      case 'bathroom':
        return (
          <Bath
            {...iconProps}
            className={cn(iconProps.className, 'text-blue-400')}
          />
        );
      case 'kitchen':
        return (
    ...
    switch (element.type) {
      case 'chair':
        ...
        style.backgroundColor =
          style.backgroundColor || (darkMode ? '#3b82f6' : '#3b82f6');
      ...
      case 'sofa':
        ...
        style.backgroundColor =
          style.backgroundColor || (darkMode ? '#8b5cf6' : '#8b5cf6');
      ...
      case 'table':
        ...
        style.backgroundColor =
          style.backgroundColor || (darkMode ? '#0891b2' : '#0891b2');
      ...
      case 'window':
        style.backgroundColor =
          style.backgroundColor || (darkMode ? '#1e3a8a' : '#e0f2fe');
        style.borderStyle = 'solid';
        style.borderWidth = '2px';
      ...
      case 'kitchen':
        style.backgroundColor =
          style.backgroundColor || (darkMode ? '#7f1d1d' : '#fee2e2');
      ...
      case 'plant':
        style.backgroundColor =
          style.backgroundColor || (darkMode ? '#064e3b' : '#ecfdf5');
