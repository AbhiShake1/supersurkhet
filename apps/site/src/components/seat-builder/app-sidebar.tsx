...
export function AppSidebar({ currentFloor, onAddElement, onUpdateElement, selectedElement, setSelectedElement, onUpdateFloor, darkMode, onToggleDarkMode, previewMode, onTogglePreview }: AppSidebarProps) {
                    ...
                    <SidebarGroup>
                        ...
                        <div className="space-y-4 p-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <Button disabled={!selectedElement} className="w-full" variant="outline" onClick={() => setSelectedElement(null)}>
                                    Clear Selection
                                </Button>
                            </div>
                        </div>
