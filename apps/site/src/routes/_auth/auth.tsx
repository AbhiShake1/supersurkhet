            ...
            <form action="" className="bg-card m-auto h-fit w-full max-w-sm rounded-[calc(var(--radius)+.125rem)] border p-0.5 shadow-md dark:[--color-muted:var(--color-zinc-900)]">
                <div className="p-8 pb-6">
                    <div>
                        ...
                        <h1 className="mb-1 mt-4 text-xl font-semibold">{isSignup ? 'Create your account' : 'Sign In to Surkhet'}</h1>
                        <p className="text-sm">{isSignup ? 'Get started with your free account' : 'Welcome back! Sign in to continue'}</p>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className={`grid ${isSignup ? 'grid-cols-2 gap-4' : 'grid-cols-1'}`}>
                            <PasswordInput
                                label="Password"
                                required
                                name="pwd"
