...
const RestaurantClientPage = lazy(
	() => import("@/components/pages/restaurant/restaurant-client-page"),
);
const HotelClientPage = lazy(
	() => import("@/components/pages/hotel/hotel-client-page"),
);
const PetrolPumpClientPage = lazy(
	() => import("@/components/pages/petrol-pump/petrol-pump-client-page"),
);
const GymClientPage = lazy(
	() => import("@/components/pages/gym/gym-client-page"),
);
const CinemaClientPage = lazy(
	() => import("@/components/pages/cinema/cinema-client-page"),
);
const FinancialFirmClientPage = lazy(
	() => import("@/components/pages/financial-firm/financial-firm-client-page"),
);
const RideSharingClientPage = lazy(
	() => import("@/components/pages/ride-sharing/ride-sharing-client-page"),
);
const ServiceClientPage = lazy(
	() => import("@/components/pages/service/service-client-page"),
);
const EducationClientPage = lazy(
	() => import("@/components/pages/education/education-client-page"),
);
const HealthcareClientPage = lazy(
	() => import("@/components/pages/healthcare/healthcare-client-page"),
);
const RealEstateClientPage = lazy(
	() => import("@/components/pages/real-estate/real-estate-client-page"),
);
const CooperativeClientPage = lazy(
	() => import("@/components/pages/cooperative/cooperative-client-page"),
);
	...
	component: () => {
		...
		function getChild() {
			...
			switch (business.businessType) {
				case "food":
					return (
						<RestaurantClientPage slug={businessName} business={business} />
					);
				case "hotel":
