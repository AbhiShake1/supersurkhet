...
// .wrangler/tmp/bundle-397Cu7/checked-fetch.js
...
// ../../node_modules/.pnpm/wrangler@3.114.5_@cloudflare+workers-types@4.20250413.0/node_modules/wrangler/templates/modules-watch-stub.js
...
// ../../node_modules/.pnpm/gun@0.2020.1240/node_modules/gun/gun.js
var require_gun = __commonJS({
  "../../node_modules/.pnpm/gun@0.2020.1240/node_modules/gun/gun.js"(exports, module) {
    init_checked_fetch();
    init_modules_watch_stub();
    (function() {
      ...
      USE(function(module2) {
        ...
        (function() {
          var sT = setTimeout, t = sT.turn = sT.turn || function(f2) {
            1 == s.push(f2) && p(T);
          }, s = t.s = [], p = sT.poll, i = 0, f, T = /* @__PURE__ */ __name(function() {
            if (f = s[i++]) {
              f();
            }
            if (i == s.length || 99 == i) {
        ...
        (function() {
          ...
          (sT.each = sT.each || function(l, f, e, S) {
            S = S || 9;
            (/* @__PURE__ */ __name(function t(s, L, r) {
      ...
      ;
      USE(function(module2) {
        module2.exports = /* @__PURE__ */ __name(function onto(tag, arg, as) {
          if (!tag) {
            return { to: onto };
          }
      ...
      USE(function(module2) {
        USE("./onto");
        module2.exports = /* @__PURE__ */ __name(function ask(cb, as) {
          if (!this.on) {
            return;
          }
      ...
      USE(function(module2) {
        ...
        (function() {
          ...
          function put(msg) {
            ...
            (/* @__PURE__ */ __name(function pop(o) {
              if (nj != ni) {
                nj = ni;
                if (!(soul = nl[ni])) {
          ...
          var cut = /* @__PURE__ */ __name(function(s) {
            return " '" + ("" + s).slice(0, 9) + "...' ";
          }, "cut");
          var L = JSON.stringify, MD = 2147483647, State = Gun3.state;
          var C2 = 0, CT, CF = /* @__PURE__ */ __name(function() {
        ...
        (function() {
          ...
          function ack(msg, node) {
            ...
            node && (/* @__PURE__ */ __name(function go() {
              S = +/* @__PURE__ */ new Date();
              var i = 0, k, put = {}, tmp;
              while (i < 9 && (k = keys[i++])) {
              ...
              var faith;
              if (F) {
                faith = /* @__PURE__ */ __name(function() {
                }, "faith");
        ...
        (function() {
          Gun3.chain.opt = function(opt) {
            ...
            obj_each(opt, /* @__PURE__ */ __name(function each(k) {
              var v = this[k];
            ...
            at.opt.from = opt;
            Gun3.on("opt", at);
            at.opt.uuid = at.opt.uuid || /* @__PURE__ */ __name(function uuid(l) {
              return Gun3.state().toString(36).replace(".", "") + String.random(l || 12);
            }, "uuid");
            return gun;
          };
        })();
        var obj_each = /* @__PURE__ */ __name(function(o, f) {
          Object.keys(o).forEach(f, o);
        }, "obj_each"), text_rand = String.random, turn = setTimeout.turn, valid = Gun3.valid, state_is = Gun3.state.is, state_ify = Gun3.state.ify, u, empty = {}, C;
        Gun3.log = function() {
      ...
      USE(function(module2) {
        ...
        __name(ack, "ack");
        var empty = {}, u, text_rand = String.random, valid = Gun3.valid, obj_has = /* @__PURE__ */ __name(function(o, k) {
          return o && Object.prototype.hasOwnProperty.call(o, k);
        }, "obj_has"), state = Gun3.state, state_is = state.is, state_ify = state.ify;
      })(USE, "./chain");
      ;
      USE(function(module2) {
        var Gun3 = USE("./root");
        ...
        function soul(gun, cb, opt, as) {
          ...
          cat.jam = [[cb, as]];
          gun.get(/* @__PURE__ */ __name(function go(msg, eve) {
      ...
      USE(function(module2) {
        ...
        function stun(as, id) {
          ...
          id = (id._ || "").id || id;
          var run = as.root.stun || (as.root.stun = { on: Gun3.on }), test = {}, tmp;
        ...
        ran.err = function(as, err) {
          (as.ack || noop).call(as, as.out = { err: as.err = Gun3.log(err) });
          as.ran(as);
        };
        function get(as) {
          var at = as.via._, tmp;
        ...
        __name(check, "check");
        var u, empty = {}, noop = /* @__PURE__ */ __name(function() {
        }, "noop"), turn = setTimeout.turn, valid = Gun3.valid, state_ify = Gun3.state.ify;
        var iife = /* @__PURE__ */ __name(function(fn, as) {
          fn.call(as || empty);
        }, "iife");
      })(USE, "./put");
      ;
      ...
      USE(function(module2) {
        ...
        var empty = {}, noop = /* @__PURE__ */ __name(function() {
        }, "noop"), u;
      })(USE, "./on");
      ;
      USE(function(module2) {
        ...
        Gun3.chain.map = function(cb, opt, t) {
        ...
        }, "noop"), event = { stun: noop, off: noop }, u;
      })(USE, "./map");
      ;
      USE(function(module2) {
        var Gun3 = USE("./index");
      ...
      USE(function(module2) {
        ...
        function Mesh(root) {
          var mesh = /* @__PURE__ */ __name(function() {
          }, "mesh");
          var opt = root.opt || {};
          ...
          var tomap = /* @__PURE__ */ __name(function(k, i, m) {
            m(k, true);
          }, "tomap");
          hear.c = hear.d = 0;
          ;
          (function() {
            ...
            mesh.hash = function(msg, peer) {
              var h, s, t;
              var S = +/* @__PURE__ */ new Date();
              json(msg.put, /* @__PURE__ */ __name(function hash(err, text) {
      ...
      USE(function(module2) {
        ...
        Gun3.on("opt", function(root) {
          ...
          function reconnect(peer) {
            ...
            peer.defer = setTimeout(/* @__PURE__ */ __name(function to() {
              if (doc && doc.hidden) {
      ...
      USE(function(module2) {
        ...
        Gun.on("create", /* @__PURE__ */ __name(function lg(root) {
          this.to.next(root);
    ...
    (function() {
      ...
      var DEP = /* @__PURE__ */ __name(function(n) {
...
// ../../node_modules/.pnpm/gun@0.2020.1240/node_modules/gun/browser.js
var require_browser = __commonJS({
  "../../node_modules/.pnpm/gun@0.2020.1240/node_modules/gun/browser.js"(exports, module) {
    init_checked_fetch();
    init_modules_watch_stub();
...
// .wrangler/tmp/bundle-397Cu7/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-397Cu7/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
// ../../node_modules/.pnpm/wrangler@3.114.5_@cloudflare+workers-types@4.20250413.0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
init_checked_fetch();
init_modules_watch_stub();
...
// ../../node_modules/.pnpm/wrangler@3.114.5_@cloudflare+workers-types@4.20250413.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
init_checked_fetch();
init_modules_watch_stub();
...
// ../../node_modules/.pnpm/wrangler@3.114.5_@cloudflare+workers-types@4.20250413.0/node_modules/wrangler/templates/middleware/common.ts
init_checked_fetch();
init_modules_watch_stub();
