/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 844175684d7961119bab56155f7c4ca2)
// Runtime types generated with workerd@1.20251004.0 2024-02-15 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GunRelay";
	}
	interface Env {
		GUN_PEERS: "";
		S3_BUCKET: string;
		...
		S3_ENDPOINT: string;
		S3_REGION: string;
		RELAY: DurableObjectNamespace<import("./src/index").GunRelay>;
	}
}
